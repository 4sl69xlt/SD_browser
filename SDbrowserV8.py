...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.out_dir_input.setReadOnly(True)           # jen pro čtení
        self.out_dir_input.setMinimumWidth(200)        # šířka pole
        ...
        self.out_input.setFixedWidth(40)  # aby se vešlo číslo
        ...
        top_bar.addWidget(self.out_dir_input)  # přidáme do stejného řádku s input číslem
    ...
    def select_out_folder(self):
            folder = QtWidgets.QFileDialog.getExistingDirectory(self, "Vyber cílovou složku")
            if folder:
                self.out_folder = folder
                 # QtWidgets.QMessageBox.information(self, "Info", f"Cílová složka nastavena: {folder}")
